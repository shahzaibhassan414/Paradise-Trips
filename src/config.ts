...
export const OPERATIONAL_OFFICES: OfficeLocation[] = [
  ...
  {
    city: "Lahore (Garden Town)",
    name: "Lahore Garden Town Branch",
    type: "Branch Office",
    address: "Flat #303, 3rd Floor, Building #23 Civic Center, Barkat Market, New Garden Town, Lahore",
    phone: "+92 323 7266292",
    isHeadOffice: false,
  },
  {
    ...
    type: "Branch Office",
    address: "G-31 Office, Bhutta Center, GT Road, Near Nigar Chowk, Gujranwala",
    phone: "+92 323 7266292",
    isHeadOffice: false,
  },
  {
    city: "Rawalpindi / Wah Cantt",
    name: "Rawalpindi / Wah Cantt Office",
    type: "Regional Office",
    address: "Shop No. 3, Lower Ground, City Market Plaza, Opposite Tandoori Restaurant, New City Phase II, Wah Cantt",
    phone: "+92 323 7266292",
    isHeadOffice: false,
  },
  {
    ...
    name: "Sialkot Office",
    type: "Branch Office",
    address: "Office No. 8, Allama Iqbal Market, Paris Road, Opposite Bank Al Habib (Beside Ufone Office), Sialkot",
    phone: "+92 323 7266292",
    isHeadOffice: false,
  },
  {
    ...
    type: "Branch Office",
    address: "Al Khair Market, Old Shama Cinema, Main Bazar, Haroonabad",
    phone: "+92 323 7266292",
    isHeadOffice: false,
  },
  {
    ...
    type: "Branch Office",
    address: "Mian Usman Marble & Granite, Opposite Safari Park, Chishtian",
    phone: "+92 323 7266292",
    isHeadOffice: false,
  },
];
...
export const config: SiteConfig = {
  ...
  addresses: {
    ...
    lahoreBranch: "Flat #303, 3rd Floor, Building #23 Civic Center, Barkat Market, New Garden Town, Lahore",
  },
  ...
  tours: [
    {
      ...
      departureSchedule: "Every Saturday & Friday",
      upcomingDates: [
      ...
      exclusions: [
        ...
        "Boating/Jet Skiing fees at Attabad Lake or Upper Kachura",
    ...
    },
    {
      ...
      title: "5 Days — Hunza Valley, Attabad Lake, Khunjerab Pass & Naltar",
      ...
      departureSchedule: "Every Thursday & Sunday",
      upcomingDates: [
    ...
    {
      id: "fairy-meadows-5d",
      slug: "5-days-fairy-meadows-nanga-parbat-beyal-camp",
      title: "5 Days — Fairy Meadows & Nanga Parbat Basecamp Trek",
      subtitle: "Thrilling 4x4 Raikot jeep track, lush alpine forest hike, Beyal Camp, and Nanga Parbat (8,126m) views.",
      duration: "5 Days / 4 Nights",
      days: 5,
      nights: 4,
      ...
      departureSchedule: "Every Thursday",
      upcomingDates: [
    ...
    },
    {
      ...
      departureSchedule: "Every Thursday & Friday",
      upcomingDates: [
